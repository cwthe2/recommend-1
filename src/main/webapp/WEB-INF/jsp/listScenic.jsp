...
<link type="text/css" rel="Stylesheet" href="${pageContext.request.contextPath}/dataView/imgFlow/css/imageflow.css" />

<script type="text/javascript" src="${pageContext.request.contextPath}/dataView/imgFlow/js/jquery.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/dataView/imgFlow/js/imageflow.js"></script>
