  ...
  <div class="row">
    ...
    <div class="col-md-12 col-lg-3">
      <div class="widget profile-widget" style="height:380px;">
        <img src="${pageContext.request.contextPath}/dataView/img/profileimg.png" class="profile-image" alt="img">
        <h1>Jonathan Doe</h1>
        ...
        <ul class="mailbox-inbox">
            ...
            <li>
              <a href="#" class="item clearfix">
                <img src="${pageContext.request.contextPath}/dataView/img/profileimg.png" alt="img" class="img">
            ...
            <li>
              <a href="#" class="item clearfix">
                <img src="${pageContext.request.contextPath}/dataView/img/profileimg2.png" alt="img" class="img">
            ...
            <li>
              <a href="#" class="item clearfix">
                <img src="${pageContext.request.contextPath}/dataView/img/profileimg3.png" alt="img" class="img">
            ...
            <li>
              <a href="#" class="item clearfix">
                <img src="${pageContext.request.contextPath}/dataView/img/profileimg4.png" alt="img" class="img">
      ...
      <div class="panel panel-widget blog-post">
        <div class="panel-body">
          ...
          <div class="image-div color10-bg">
            <img src="${pageContext.request.contextPath}/dataView/img/example1.jpg" class="image" alt="img">
          ...
          <a href="#">Read More</a>
          <p class="author">
            <img src="${pageContext.request.contextPath}/dataView/img/profileimg.png" alt="img">
      ...
      <div class="panel panel-info panel-widget">
        ...
        <div class="panel-body">
          <ul class="basic-list image-list">
            <li><img src="${pageContext.request.contextPath}/dataView/img/profileimg.png" alt="img" class="img"><b>Jonathan Doe</b><span class="desc">Designer</span></li>
            <li><img src="${pageContext.request.contextPath}/dataView/img/profileimg2.png" alt="img" class="img"><b>Egemem Ka</b><span class="desc">Front-End Developer</span></li>
            <li><img src="${pageContext.request.contextPath}/dataView/img/profileimg3.png" alt="img" class="img"><b>Timmy Jefsin</b><span class="desc">Back-End Developer</span></li>
            <li><img src="${pageContext.request.contextPath}/dataView/img/profileimg4.png" alt="img" class="img"><b>James K. Throwing</b><span class="desc">Marketing</span></li>
            <li><img src="${pageContext.request.contextPath}/dataView/img/profileimg5.png" alt="img" class="img"><b>John Doe</b><span class="desc">iOS Developer</span></li>
          </ul>
        </div>
      </div>
    </div>
